...
async function project(description, options) {
  ...
  if (!description || !description.trim()) {
    ...
    console.log(chalk.dim('  Example: agentforge project "FastAPI REST API with PostgreSQL and Redis"'));
    process.exit(1);
  }
...
function buildContextFile(description, labels, context, targetDir) {
  const lines = [
    ...
    '',
    '> This file was generated by `agentforge project`. It is read by the `/setup-project`',
...
function printGuide(description, labels, targetDir) {
  console.log('');
  console.log(chalk.bold.cyan('  agentforge') + chalk.dim('  —  Project Setup'));
